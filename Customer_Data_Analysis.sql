...
-- Q7. Segment customers into New, Returning, asnd loyal based on their total number of 
...
CASE
    WHEN age BETWEEN 1 AND 18 THEN 'Young_Adult'
	WHEN age BETWEEN 19 AND 25 THEN 'Middle_Aged'
